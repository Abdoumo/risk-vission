    ...
    <div className="rounded-2xl border border-white/5 bg-slate-900/40 backdrop-blur-md p-6 transition-all duration-300 hover:border-emerald-500/20 hover:shadow-[0_0_30px_rgba(16,185,129,0.05)] h-full">
      ...
      <ResponsiveContainer width="100%" height={320}>
        <RadarChart cx="50%" cy="50%" outerRadius="70%" data={data}>
          ...
          <Radar name="LSTM"         dataKey="LSTM"         stroke="#10b981" fill="#10b981" fillOpacity={0.15} strokeWidth={2.5} />
          <Radar name="XGBoost"      dataKey="XGBoost"      stroke="#059669" fill="#059669" fillOpacity={0.1}  strokeWidth={2.5} />
