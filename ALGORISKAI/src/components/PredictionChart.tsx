    ...
    <div className="rounded-2xl border border-white/5 bg-slate-900/40 backdrop-blur-md p-6 transition-all duration-300 hover:border-cyan-500/20 hover:shadow-[0_0_30px_rgba(34,211,238,0.05)]">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart data={displayData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
          ...
          <Area type="monotone" dataKey="reel"     stroke="#0ea5e9" strokeWidth={3} fill="url(#gradReel)"   name={t('real')}      dot={false} connectNulls={false} />
          <Area type="monotone" dataKey="predit"   stroke="#22d3ee" strokeWidth={2} strokeDasharray="5 5" fill="url(#gradPredit)" name={t('predicted')} dot={false} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
