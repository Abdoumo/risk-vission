...
export default function LoginView() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -mr-32 -mt-32 w-96 h-96 rounded-full bg-green-500/5 blur-[120px]" />
      <div className="absolute bottom-0 left-0 -ml-32 -mb-32 w-96 h-96 rounded-full bg-green-500/5 blur-[120px]" />

      <div className="max-w-md w-full bg-slate-900/80 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-8 shadow-2xl relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <>
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-slate-950/50 border border-slate-800 rounded-xl px-4 py-3 text-slate-200 placeholder:text-slate-600 focus:ring-2 focus:ring-green-500/50 focus:border-green-500/50 outline-none transition-all shadow-inner"
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full mt-2 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-green-500/20 disabled:opacity-50 flex justify-center items-center gap-2"
          >
            {loading ? (
              <>
